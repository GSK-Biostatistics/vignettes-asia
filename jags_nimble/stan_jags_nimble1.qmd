---
title: "Logistic BHM - RStan v JAGS v Nimble"
output:
...
### Quickstart
This vignette compares the same Bayesian hierarchical model fitted first with Rstan, JAGS and Nimble. Only key snippets and outputs are shown below. The full vignette is available [here](https://raw.githubusercontent.com/GSK-Biostatistics/vignettes-asia/refs/heads/main/jags_nimble/stan_jags_nimble1.qmd.qmd). 
...
```{r, jagsmod, include=TRUE,results='hide',eval=TRUE}
BHM_jags_2 <- "
model {
for (i in 1:N) {
...
```{r, plot_res, eval=TRUE, include=TRUE}
df <- data.frame(
